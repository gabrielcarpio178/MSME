...
<body>
    ...
    <div class="content d-flex flex-row w-100 animate__animated animate__fadeIn">
        ...
        <div class="w-50  d-flex align-content-center justify-content-center">
            <div class="d-flex flex-column w-100 p-md-5 animate__animated animate__fadeInRight">
                ...
                <div class="d-flex flex-column gap-2 px-5">
                    ...
                    <?php if(isset($_GET['role']) && $_GET['role']==='rider') include("subpages/signup/rider-form.php") ?>
                </div>
            </div>
